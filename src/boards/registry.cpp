...
std::vector<BoardType> boardTypes() {
    return {
        ...
        {"64fdc", "Cromemco 64FDC: the 16FDC's 1983 successor -- same FD1793 + TMS 5501 + 4K RDOS PROM, carrying RDOS 3.12. Boots CDOS"},
        ...
        // NO LAMPS HERE. The line used to end "and the lamps", which promised an operator
        // something there is no way to see and no plan to build. And the panel has no DATA
        // switches to offer instead: it is ONE row of sixteen ADDRESS switches, SA0..SA15,
        // and the top eight are the ones a program reads at port FF.
