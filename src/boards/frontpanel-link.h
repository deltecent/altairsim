...
// the bridge-composed run/halt/wait group, which altairsim does not model yet and
// passes as 0 (the spec's §3 machine-control indicators -- see the plan's Deferred).
