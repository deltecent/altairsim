...
| *later* | PMMI MM-103, ~~VDM-1~~ (**built 2026-07-18** — `docs/boards/proctech-vdm1.md`, and the **Sol-20** with it), ~~Dazzler~~ (**built 2026-07-23** — `docs/boards/cromemco-dazzler.md`; `dazzler`, KSCOPE in `examples/dazzler/`) | see below |
